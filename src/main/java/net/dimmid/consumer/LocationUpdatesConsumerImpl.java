...
public class LocationUpdatesConsumerImpl implements GameConsumer {
    ...
    public LocationUpdatesConsumerImpl(GameKafkaConsumer consumer,
                                       BlockingQueue<Map<String, String>> locationUpdateOutputQueue) {
        this.consumer = consumer.getConsumer();
        this.outputQueue = locationUpdateOutputQueue;
    }
